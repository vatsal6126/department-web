...
export const AdminLogin: React.FC = () => {
  ...
  const { signIn, isAdmin, loading, isSupabaseConfigured } = useAuth();
    ...
    <main className="page-container admin-login-page">
      ...
      <div className="content-card admin-login-card admin-form">
        ...
        {!isSupabaseConfigured && (
          <p className="admin-login-error" role="alert">Supabase is not configured. Add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY.</p>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary" disabled={submitting || !isSupabaseConfigured}>{submitting ? 'Signing in...' : 'Sign in'}</button>
        </form>
